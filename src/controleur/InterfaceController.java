...
public class InterfaceController {
	...
	public void ajouterEtape() {
		...
		// a faire mario et jj
		//this.livraison = plan.ajouterSommet(this.livraison, "nouvelle intersection", "intersection precedente", LONG "demander la dur�e")
		// this.livraison = plan.ajouterSommet(this.livraison, "nouvelle intersection", "intersection precedente", LONG "demander la dur�e")
		// this.livraison = plan.ajouterSommet(this.livraison, "nouvelle intersection", "intersection precedente", LONG "demander la dur�e")
	...
	public void supprimerEtape() {
		System.out.println("tout marche");
		// � faire mario et jj
		// this.livraison = plan.supprimerSommet(this.livraison, "intersection � supprimer")
