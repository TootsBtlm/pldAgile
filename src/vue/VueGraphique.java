...
public class VueGraphique {
	...
	/**
	 * Méthode permettant de dessiner le plan sur l'écran
	 */
	...
	/**
	 * Méthode permettant de dessiner les requêtes sur l'écran
	 * @param er Ensemble des requêtes à dessiner
	 */
	...
	/**
	 * Méthode permettant de dessiner sur l'écran l'itinéraire de livraison
	 * @param livraison L'itinéraire à dessiner
	 */
